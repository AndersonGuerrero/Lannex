...
<div id="ei-slider" class="ei-slider">
    <ul class="ei-slider-large">
        <li>
            <?php echo $this->Html->image("tecno6.jpg", array("alt" => "Cobertura Turmero", "class" => "responsiveslide")); ?>
            <div class="ei-title">
                <h2>Lannex, C.A.</h2>
            </div>
        </li>
        ...
        <li>
            <?php echo $this->Html->image("tecno8.jpg", array("alt" => "Cobertura Turmero", "class" => "responsiveslide")); ?>
...
<div class="row">
    <div class="twelve columns">
        <ul class="ca-menu">
            <li>
                <a href="<?php echo $this->Html->url(array('controller' => 'notificacion', 'action' => 'Pago')); ?>">

                    <span class="ca-icon">ó</span>
            ...
            <li>
                <a href="<?php echo $this->Html->url(array('controller' => 'inicio', 'action' => 'ZonasDeCobertura')); ?>">
                    <span class="ca-icon">q</span>
                    <div class="ca-content">
                        <h2 class="ca-main">Zonas<br>De<br>Cobertura</h2>

                    </div>
                </a>
            </li>
            <li>
                <a href="<?php echo $this->Html->url(array('controller' => 'inicio', 'action' => 'Fecha_de_corte')); ?>">
            ...
            <li>
                <a href="<?php echo $this->Html->url(array('controller' => 'inicio', 'action' => 'DatosBancarios')); ?>">
...
<div class="row">
    ...
    <div class="four columns">
        ...
        <p>
            ...
            512/128  Kbps 	= 545,00 Bs.<br>

            728/128  Kbps 	= 725,00 Bs.<br>

            1024/256 Kbps 	= 1090,00 Bs.<br>

            1532/512 Kbps 	= 1913,00 Bs.<br>
    ...
    <div class="four columns">
        ...
        <p>
            ...
            728/128  Kbps = 1.441.44 Bs.<br>

            1024/256 Kbps = 2.038,40 Bs.<br>

            1532/512 Kbps = 2.475,20 Bs.<br>
